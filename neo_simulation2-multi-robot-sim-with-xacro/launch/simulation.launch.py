...
# Modified to use yaw angle directly for robot orientation
...
def execution_stage(context: LaunchContext, namespace_val):
    ...
    yaw = LaunchConfiguration('yaw', default='0.0')  # Yaw angle in radians
    ...
    return [spawn_entity, start_robot_state_publisher_cmd, relay_topic, relay_topics_tf_static] #teleop commented out for my tests
...
def generate_launch_description():
    ...
    return LaunchDescription([yaw_arg, opq_function, gazebo])
